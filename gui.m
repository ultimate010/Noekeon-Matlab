...
% Last Modified by GUIDE v2.5 27-May-2015 23:19:00
...
out_path = get(handles.output_path,'String')
...
decrypt_file(input_path, out_path, k);
fprintf('Done\n');
...
set(handles.input_path,'String',input);
...
[FileName,PathName,FilterIndex] = uigetfile;
input = strcat(PathName, FileName);
set(handles.output_path,'String',input);
